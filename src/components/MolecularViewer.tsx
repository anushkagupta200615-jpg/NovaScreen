...
export default function MolecularViewer({ pdbId }: MolecularViewerProps) {
  ...
  useEffect(() => {
    ...
    const loadViewer = async () => {
      ...
      try {
        ...
        viewer.setBackgroundColor(0x020617, 0); // Transparent or slate-950
  ...
  return (
    <div className="relative w-full h-[400px] glass-panel flex items-center justify-center overflow-hidden">
      ...
      {loading && (
        <div className="absolute inset-0 flex items-center justify-center bg-slate-950/50 backdrop-blur-sm z-10 rounded-2xl">
